...
This data set contains a character vector of 2-letter abbreviations for the state names in the USA [@state]. 

|Variable                              |Class  |Description |
|:-----------|:---|:-----------|
|state.abb                             |character |     2-letter for the state names        |
...
|Variable                         |Class     |Description |
|:-----------|:------|:-----------|
|GeoFIPS                          |character |            Five-digit Federal Information Processing Standards code |
|GeoName                          |character |            Geographic Name |
|Region                           |double |               Region|
|TableName                        |character |            Table Name|
|LineCode                         |double |               Line code of each state |
|IndustryClassification           |character |            Industry Classification |
|Description                      |character |            Description the meaning of each amount |
|Unit                             |double |               Unit of measure |
|Year                             |double |               Amount in each year |
