...
ggplot(all_states, aes(x = x, y = y, group = group, fill = mean)) + 
  ...
  scale_fill_gradient(name = "Percent", low = "white", high = "black", guide = "colorbar", na.value = "black", breaks = pretty_breaks(n = 5)) +
...
ggplot(gdp, aes(x = x, y = y, group = group, fill = avg)) + 
  geom_polygon(color = "white", show.legend = T) +
  scale_fill_gradient(name = "Percent", low = "white", high = "blue", guide = "colorbar", na.value = "black", breaks = pretty_breaks(n = 5)) +
  labs(title = "House Price Index in Each State in USA", x = "Longitude", y = "Latitude") +
  theme_minimal() +
  theme(plot.title = element_text(hjust = 0.5, size = 16)) +
  # geom_text(data = statements_gdp, aes(x = long, y = lat, lable = region), size = 3) +
  theme_bw()+
  # theme(panel.grid=element_blank(),panel.border=element_blank(),axis.line=element_line(size=1,colour="black"))+
  theme(axis.ticks.y = element_blank(), axis.text.y = element_blank()) +
  theme(axis.ticks.x = element_blank(), axis.text.x = element_blank()) +
