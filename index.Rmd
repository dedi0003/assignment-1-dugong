...
The motivation of this report is to learn about the behaviour of House Price Index in the U.S. and how it is affected by economy and the market. Through our analysis we will try to identify any relation between HPI at national level and at state level. The report will also analyse the effect of the external factors like recession and mortgage rates on HPI.
...
As part of analysis we need to have the data in a time series format.  
...
Analyzing the trend of United States national HPI requires 
...
From Figure 1, we can look at the U.S. Average HPI from 1975 to 201
